...
public class MyGdxGame implements ApplicationListener {
	...
	{		
		...
		texture_nave = new Texture(Gdx.files.internal("data/enemigo.png"));
		sprite_nave=new Sprite(texture_nave,32,64);
		...
		for(int i=0;i<5;i++)
		{
			Pelotita p=new Pelotita((int )(Math.random()*1000%w),(int)(Math.random()*1000%h),new Texture("data/pelotita.png"));
